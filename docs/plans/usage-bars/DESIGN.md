...
poller updates utilization and observation timestamps while preserving header-derived reset and
status metadata; failed or unrecognized observations preserve prior state. The historical M12
