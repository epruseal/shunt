...
- 쿼터 버킷과 그 창별 status는 리셋 타임스탬프가 지나면 자동으로 비워집니다. non-Fable 성공 응답은 계정 전체 쿨다운만 해제하고 Fable 전용 쿨다운은 그대로 둡니다; Fable 성공 응답은 두 쿨다운을 모두 해제합니다.
